...
$query = "SELECT id, customer_name, mobile_number, email, source, interested_services, enquiry_date, preferred_date, preferred_time, enquiry_status FROM enquiries";
...
?>
    ...
    <?php foreach ($enquiries as $enquiry): ?>
        <tr>
            ...
            <td><?php echo htmlspecialchars($enquiry['source']); ?></td>
