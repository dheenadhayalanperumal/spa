...
!(function (t) {
  ...
  function A(t, e) {
    ...
    for (
      n = 0;
      n < Yt.length && ((i = Yt[n]), (r = V(i, t, e)), !(r >= 1 && ot(r)));
      n++
    );
    return i;
  }
    ...
    return (
      this.each(function (r, s) {
        ...
        "string" == typeof e
          ...
          : a || ((a = new fe(l, e)), l.data("fullCalendar", a), a.render());
      }),
      i
    );
  };
        ...
        t
          ? ((n = { left: E(t), top: b(t) }),
            ...
            r &&
              ...
              (this.origHit && (e = x(this.origHit, e) || e), (i = I(e))),
        ...
        var t,
          ...
          i = new re(this, {
            ...
            hitOver: function (n, i, r) {
              r &&
                ((t = e.computeSelection(e.getHitSpan(r), e.getHitSpan(n))),
  ...
  var de = (Ot.View = ct.extend(Jt, te, {
      ...
      computeTitle: function () {
        var t, e;
        return (
          "year" === this.intervalUnit || "month" === this.intervalUnit
